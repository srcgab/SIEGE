    ...
    return (
        <>
            <main className={cx(styles["form-signin"],"text-center","mt-5")}>
                <form>
                <h1 className="text-7xl text-pink-900 font-['Iceberg']">SIEGE</h1>
                <br></br>
                    ...
                    <button onClick={handleClick} className={cx(styles["bg-pink"],"w-100 btn btn-lg btn-primary mt-2 bg-pink")} type="submit">Entrar sem login</button>
                    <br></br>
                    <br></br>
                    <p>Quer realizar postagens?</p>
                    <button onClick={handleSignUp} className={cx(styles["bg-pink"],"w-100 btn btn-lg btn-primary mt-2 bg-pink")} type="submit">Cadastrar</button>
                </form>
            </main>
        </>
    )
