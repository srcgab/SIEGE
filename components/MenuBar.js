...
export default function MenuBar() {
  ...
  return (
    <div className="hidden sm:flex flex-col pt-2 xl:items-start fixed h-full xl:ml-24">
      {/*Logo*/}
      <div className="">
        <h1 className="text-7xl text-pink-900 font-['Iceberg']" >
          SIEGE
        </h1>
      </div>

        {/*Menu*/}
        <div className="font-bold mt-4 mb-2.5 xl:items-start flex-shrink-0">
        ...
        {/*Botão Criar Evento*/}          
        <button onClick={() => { 
          setOpen(!open); }} className="mb-3 bg-pink-900 text-white rounded-full w-56 h-12 font-bold shadow-md hover:gray-800 text-lg hidden xl:inline">
           Criar Evento
          </button>
        ...
        {/*Usuário/Sair*/}
        <div className="mb-3 hoverEffect text-gray-700 flex items-center justify-center xl:justify-start mt-auto w-[90%] xl:w-[80%]">
          <img
